...
export const projectData = [
  ...
  // },
  {
    ...
    img: eshop,
    title: "Eshop B2B",
    desc: "Eshop B2B website, developped during my internship at inwi using NextJS, ReactJS, TypeScript, Material UI.",
  ...
  },
  {
    ...
    img: todos,
    title: "Do It Now",
    desc: "A To do list application. Developped using ReactJS, TypeScript, and Bootstrap.",
  ...
  },
  {
    ...
    img: game,
    title: "Game Over",
    desc: "A website of games. Developed using HTML, CSS, and Bootstrap.",
  ...
  },
  {
    ...
    img: note,
    title: "Keep Notes",
    desc: "A website to take, delete, edit notes. Developed using HTML, CSS, JavaScript.",
